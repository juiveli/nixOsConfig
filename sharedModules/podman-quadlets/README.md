...
If using system user, easiest way to debug is by going into system user context first with

`sudo -u <USERNAME> -i`

Then you can use systemctl and journalctl from specicic users point of view
**systemctl:**
